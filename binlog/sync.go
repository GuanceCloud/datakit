...
func (c *Binloger) startSyncer() (*replication.BinlogStreamer, error) {
...
func (c *Binloger) updateTable(db, table string) (err error) {
...
func (c *Binloger) updateReplicationDelay(ev *replication.BinlogEvent) {
	var newDelay uint32
...
func (c *Binloger) WaitUntilPos(pos mysql.Position, timeout time.Duration) error {
...
func (c *Binloger) GetMasterPos() (mysql.Position, error) {
...
func (c *Binloger) GetMasterGTIDSet() (mysql.GTIDSet, error) {
	query := ""
	switch c.cfg.Flavor {
...
func (c *Binloger) CatchMasterPos(timeout time.Duration) error {
