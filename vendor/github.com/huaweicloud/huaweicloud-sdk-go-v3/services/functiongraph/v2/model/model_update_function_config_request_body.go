...
type UpdateFunctionConfigRequestBodyCodeTypeEnum struct {
	INLINE UpdateFunctionConfigRequestBodyCodeType
	ZIP    UpdateFunctionConfigRequestBodyCodeType
	OBS    UpdateFunctionConfigRequestBodyCodeType
	JAR    UpdateFunctionConfigRequestBodyCodeType
}

func GetUpdateFunctionConfigRequestBodyCodeTypeEnum() UpdateFunctionConfigRequestBodyCodeTypeEnum {
	return UpdateFunctionConfigRequestBodyCodeTypeEnum{
		INLINE: UpdateFunctionConfigRequestBodyCodeType{
			value: "inline",
		},
		ZIP: UpdateFunctionConfigRequestBodyCodeType{
