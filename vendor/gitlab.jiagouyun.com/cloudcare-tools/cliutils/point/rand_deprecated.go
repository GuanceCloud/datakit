...
func doRandomPBPoints(count int) (*PBPoints, error) {
	...
	for i := 0; i < count; i++ {
		pts.Points = append(pts.Points, &PBPoint{
			Name: []byte(cliutils.CreateRandomString(30)),
			Tags: []*Tag{
				{Key: []byte(cliutils.CreateRandomString(10)), Val: []byte(cliutils.CreateRandomString(37))},
				{Key: []byte(cliutils.CreateRandomString(11)), Val: []byte(cliutils.CreateRandomString(38))},
				{Key: []byte(cliutils.CreateRandomString(12)), Val: []byte(cliutils.CreateRandomString(39))},
				{Key: []byte(cliutils.CreateRandomString(13)), Val: []byte(cliutils.CreateRandomString(40))},
			},
			Fields: []*Field{
				{Key: []byte(cliutils.CreateRandomString(10)), Val: &Field_S{cliutils.CreateRandomString(37)}},
