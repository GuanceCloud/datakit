...
=== "Kubernetes"
    ...
    | `ENV_INPUT_DISK_EXCLUDE_DEVICE`                      | `exclude_device`                | 忽略的device                                | `"/dev/loop0","/dev/loop1"` 以英文逗号隔开                      |
    | `ENV_INPUT_DISK_EXTRA_DEVICE`                        | `extra_device`                  | 额外增加的device                            | `"shm","tmpfs"` 以英文逗号隔开                      |
