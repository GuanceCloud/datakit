...
阿里云 NAT 并发连接数，新建连接数，VPC 流量，VPC 数据包等

![image](imgs/input-aliyun-nat-1.png)

![image](imgs/input-aliyun-nat-2.png)
...
![image](imgs/input-aliyun-nat-5.png)

2. 开启脚本市场，管理 - 实验性功能 - 开启脚本市场模块

![image](imgs/input-aliyun-nat-6.png)
...
![image](imgs/input-aliyun-nat-7.png)

4. 脚本安装完成后，可以在脚本库中看到所有脚本集

![image](imgs/input-aliyun-nat-8.png)

#### 添加脚本

1. 开发 - 脚本库 - 添加脚本集

![image](imgs/input-aliyun-nat-9.png)

2. 点击该脚本集 - 添加脚本

![image](imgs/input-aliyun-nat-10.png)

3. 创建 ID 为 main 的脚本

![image](imgs/input-aliyun-nat-11.png)
...
![image](imgs/input-aliyun-nat-13.png)

2. 自动触发配置，执行函数中添加此脚本，执行频率为 **每分钟 * * * * ***

![image](imgs/input-aliyun-nat-14.png)

3. 指标预览

![image](imgs/input-aliyun-nat-15.png)

## 场景视图

<场景 - 新建仪表板 - 内置模板库 - 阿里云 NAT>

## 指标详解

<[阿里云 NAT 指标列表](https://help.aliyun.com/document_detail/166630.htm?spm=a2c4g.11186623.0.0.43b973c2XeTSML#concept-2500106)>
