...
func buildTemplates() error {
	...
	for k, v := range map[string]string{
		...
		"templates/datakit-gke-autopilot.template.yaml":       filepath.Join(DistDir, "datakit-gke-autopilot.yaml"),
		...
		"templates/charts-values-gke-autopilot.template.yaml": filepath.Join(DistDir, "helm-values-gke-autopilot.yaml"),
		"templates/charts-Chart.template.yaml":                filepath.Join(DistDir, "helm-Chart.yaml"),
		"templates/charts-Chart-gke-autopilot.template.yaml":  filepath.Join(DistDir, "helm-Chart-gke-autopilot.yaml"),
