...
var (
	TelegrafInputs = map[string]*telegrafInput{ // Name: Catalog
		...
		"disk":              &telegrafInput{name: "disk", Catalog: "disk"},
		"cpu":               &telegrafInput{name: "cpu", Catalog: "cpu"},
		"diskio":            &telegrafInput{name: "diskio", Catalog: "diskio"},
		"mysql":             &telegrafInput{name: "mysql", Catalog: "mysql"},
		"mongodb":           &telegrafInput{name: "mongodb", Catalog: "mongodb"},
		"redis":             &telegrafInput{name: "redis", Catalog: "redis"},
		"elasticsearch":     &telegrafInput{name: "elasticsearch", Catalog: "elasticsearch"},
		"openldap":          &telegrafInput{name: "openldap", Catalog: "openldap"},
		"sqlserver":         &telegrafInput{name: "sqlserver", Catalog: "sqlserver"},
		"phpfpm":            &telegrafInput{name: "phpfpm", Catalog: "phpfpm"},
		"memory":            &telegrafInput{name: "memory", Catalog: "memory"},
		...
		"memcached":         &telegrafInput{name: "memcached", Catalog: "memcached"},
		...
		"ping_check":        &telegrafInput{name: "ping_check", Catalog: "network"},
		"postgresql":        &telegrafInput{name: "postgresql", Catalog: "postgresql"},
		"rabbitmq":          &telegrafInput{name: "rabbitmq", Catalog: "rabbitmq"},
		"swap":              &telegrafInput{name: "swap", Catalog: "swap"},
		"system":            &telegrafInput{name: "system", Catalog: "system"},
		"tengine":           &telegrafInput{name: "tengine", Catalog: "tengine"},
		"network":           &telegrafInput{name: "network", Catalog: "network"},
		"processes":         &telegrafInput{name: "processes", Catalog: "processes"},
		"tcp_udp_check":     &telegrafInput{name: "tcp_udp_check", Catalog: "network"},
		"http_check":        &telegrafInput{name: "http_check", Catalog: "http_check"},
		"kernel":            &telegrafInput{name: "kernel", Catalog: "kernel"},
		"tls":               &telegrafInput{name: "tls", Catalog: "tls"},
		"nats":              &telegrafInput{name: "nats", Catalog: "nats"},
		"win_services":      &telegrafInput{name: "win_services", Catalog: "win_services"},
		"awscloudwatch":     &telegrafInput{name: "awscloudwatch", Catalog: "aws"},
		"vmware":            &telegrafInput{name: "vmware", Catalog: "vmware"},
		"win_perf_counters": &telegrafInput{name: "win_perf_counters", Catalog: "win_perf_counters"},
		...
		"solr":              &telegrafInput{name: "solr", Catalog: "solr"},
		`systemd_units`:     &telegrafInput{name: "systemd_units", Catalog: "systemd_units"},
		`influxdb`:          &telegrafInput{name: "influxdb", Catalog: "influxdb"},
	}
