...
// Package collect contains collect implement.
package collect
...
import (
	...
	"gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/externals/db2/collect/cdb2"
)
...
func Run(opt *ccommon.Option) {
	...
	definedInputList = append(definedInputList, cdb2.NewInput)
