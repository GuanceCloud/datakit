...
// Package collect contains OceanBase collect implement.
package collect
...
import (
	...
	"gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/externals/oceanbase/collect/coceanbase"
)
...
func Run(opt *ccommon.Option) {
	...
	definedInputList = append(definedInputList, coceanbase.NewInput)
