...
func (*feMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		Name:   "doris_fe",
		Cat:    point.Metric,
		Desc:   "Apache Doris Frontend metrics scraped from Prometheus output, covering queries, metadata, jobs, transactions, scheduling, and FE service resources.",
		DescZh: "从 Prometheus 输出采集的 Apache Doris Frontend 指标，涵盖查询、元数据、作业、事务、调度和 FE 服务资源。",
		//nolint:lll
		Fields: map[string]interface{}{
			"cache_added":                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of entries added to the FE cache."},
			"cache_hit":                   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of FE cache hits."},
			...
			"edit_log":                    &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of FE metadata log entries."},
			...
			"max_tablet_compaction_score": &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NoUnit, Desc: "Largest tablet compaction score reported across all BE nodes."},
			...
			"query_err":                   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of failed FE query requests."},
			...
			"query_total":                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of FE query requests."},
			...
			"tablet_max_compaction_score": &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NoUnit, Desc: "Tablet compaction score reported by each BE node."},
			...
			"tablet_status_count":         &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of tablets by scheduler status on the master FE node."},
			...
			"txn_counter":                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of imported transactions by status."},
			...
			"query_rpc_size":              &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.SizeByte, Desc: "Specify the RPC data size of BE . For example, { be=192.168.10.1} indicates the number of RPC data bytes sent to BE with IP address 192.168.10.1."},
...
func (*jvmMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		Name:   "doris_jvm",
		Cat:    point.Metric,
		Desc:   "JVM runtime metrics for Apache Doris Frontend processes, covering heap, non-heap, young generation, old generation, and thread activity.",
		DescZh: "Apache Doris Frontend 进程的 JVM 运行时指标，涵盖堆、非堆、新生代、老年代和线程活动。",
		//nolint:lll
		Fields: map[string]interface{}{
			...
			"old_gc":              &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "JVM old-generation garbage collection count."},
...
func (*commonMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		Name:   "doris_common",
		Cat:    point.Metric,
		Desc:   "Common Apache Doris node metrics for system memory, network protocol statistics, and node inventory.",
		DescZh: "Apache Doris 节点的通用指标，涵盖系统内存、网络协议统计和节点清单。",
		//nolint:lll
		Fields: map[string]interface{}{
			...
			"node_info":      &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of Doris nodes by node type and state."},
		},
		Tags: map[string]interface{}{
			"host":     inputs.NewTagInfo("Host name."),
			"instance": inputs.NewTagInfo("Instance endpoint."),
...
func (*beMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		Name:   "doris_be",
		Cat:    point.Metric,
		Desc:   "Apache Doris Backend metrics scraped from Prometheus output, covering storage, compaction, queries, loading, caches, RPC, and execution resources.",
		DescZh: "从 Prometheus 输出采集的 Apache Doris Backend 指标，涵盖存储、压缩、查询、导入、缓存、RPC 和执行资源。",
		//nolint:lll
		Fields: map[string]interface{}{
			// be process metrics
			...
			"cache_usage_ratio":                      &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.PercentDecimal, Desc: "Usage ratio of the specified LRU cache as a value from 0 to 1."},
			"cache_lookup_count":                     &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Record the number of times the specified LRU Cache is searched."},
			...
			"cache_hit_ratio":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.PercentDecimal, Desc: "Hit ratio of the specified LRU cache as a value from 0 to 1."},
			...
			"chunk_pool_system_alloc_cost_ns":        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.DurationNS, Desc: "Cumulative time spent by SystemAllocator applying for memory."},
			...
			"chunk_pool_system_free_cost_ns":         &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.DurationNS, Desc: "Cumulative time spent by SystemAllocator releasing memory."},
			...
			"compaction_bytes_total":                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.SizeByte, Desc: "Cumulative bytes processed by compaction."},
			"compaction_deltas_total":                &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of rowset deltas processed by compaction."},
			...
			"disks_compaction_score":                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NoUnit, Desc: "Compaction score for the specified data directory."},
			...
			"compaction_waitting_permits":            &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of compaction permits currently waiting."},
			...
			"disks_local_used_capacity":              &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Local used capacity for the specified data directory."},
			"disks_remote_used_capacity":             &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Remote used capacity for the specified data directory."},
			...
			"engine_requests_total":                  &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of BE engine requests."},
			"fragment_endpoint_count":                &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of fragment endpoints by execution status on the BE."},
			...
			"local_file_open_reading":                &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Current number of open LocalFileReader instances."},
			"local_file_writer_total":                &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of opened LocalFileWriter instances."},
			...
			"memtable_flush_duration_us":             &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.DurationUS, Desc: "Cumulative time spent flushing memtables to disk."},
			"memtable_flush_total":                   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of memtable flushes written to disk."},
			...
			"query_cache_memory_total_byte":          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Bytes currently occupied by Query Cache."},
			...
			"query_cache_sql_total_count":            &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Current number of SQL cache entries."},
			"query_scan_bytes":                       &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.SizeByte, Desc: "Cumulative bytes read from Olap tables by query scan operations."},
			...
			"query_scan_rows":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative raw rows read from Olap tables by query scan operations, including rows skipped by indexes."},
			...
			"s3_bytes_read_total":                    &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.SizeByte, Desc: "Cumulative bytes read by S3FileReader."},
			"s3_file_open_reading":                   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Current number of open S3FileReader instances."},
			"scanner_thread_pool_queue_size":         &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "used for `OlapScanner` The current queued number of thread pools."},
			"segment_read":                           &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of segments read."},
			...
			"small_file_cache_count":                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Current number of small files cached by the BE."},
			...
			"streaming_load_duration_ms":             &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.DurationMS, Desc: "Cumulative execution time of all stream load tasks."},
			"streaming_load_requests_total":          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of stream load tasks."},
			"stream_load_pipe_count":                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Current number of stream load data pipelines."},
			"stream_load":                            &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of stream load requests received."},
			"tablet_base_max_compaction_score":       &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NoUnit, Desc: "Current largest base compaction score."},
			"tablet_cumulative_max_compaction_score": &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NoUnit, Desc: "Current largest cumulative compaction score."},
			...
			"timeout_canceled_fragment_count":        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Cumulative number of fragment instances canceled due to timeout."},
			"stream_load_txn_request":                &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of stream load transaction requests."},
			...
			"upload_fail_count":                      &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of rowset upload failures to remote storage."},
			...
			"upload_total_byte":                      &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Bytes of rowset data successfully uploaded to remote storage."},
			...
			"all_rowsets_num":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Current number of rowsets."},
			"all_segments_num":                       &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Current number of segments."},
			...
			// be machine metrics
			"cpu":                            &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "CPU counters collected from /proc/stat by logical core and CPU mode."},
			"disk_bytes_read":                &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.SizeByte, Desc: "Cumulative bytes read from each disk, collected from /proc/diskstats."},
			"disk_bytes_written":             &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.SizeByte, Desc: "Cumulative bytes written to each disk."},
			"disk_io_time_ms":                &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.DurationMS, Desc: "Cumulative disk I/O time in milliseconds."},
			"disk_io_time_weighted":          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.DurationMS, Desc: "Weighted cumulative disk I/O time in milliseconds."},
			"disk_reads_completed":           &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of completed disk reads."},
			"disk_read_time_ms":              &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.DurationMS, Desc: "Cumulative disk read time in milliseconds."},
			"disk_writes_completed":          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Cumulative number of completed disk writes."},
			"disk_write_time_ms":             &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.DurationMS, Desc: "Cumulative disk write time in milliseconds."},
			...
			"load_average":                   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Machine load average by interval, such as 15 minutes."},
			"max_disk_io_util_percent":       &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "Maximum disk I/O utilization percentage across all disks."},
			...
			"proc":                           &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "Current number of processes."},
