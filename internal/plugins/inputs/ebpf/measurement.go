...
func (m *ConnStatsM) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Tags: map[string]interface{}{
			...
			"server_domain":  &inputs.TagInfo{Desc: "Client domain"},
		...
		Fields: map[string]interface{}{
			...
			"packets_read":         newFInfInt("The number of packets read", inputs.NCount),
			"packets_written":      newFInfInt("The number of packets written", inputs.NCount),
			...
			"tcp_connect_attempts": newFInfInt("The number of TCP connection attempts", inputs.NCount),
			"tcp_connect_failures": newFInfInt("The number of TCP connection failures", inputs.NCount),
			"tcp_close_wait":       newFInfInt("The number of TCP_CLOSE_WAIT state transitions", inputs.NCount),
			"tcp_last_ack":         newFInfInt("The number of TCP_LAST_ACK state transitions", inputs.NCount),
			"tcp_time_wait":        newFInfInt("The number of TCP_TIME_WAIT state transitions", inputs.NCount),
		},
	}
}
...
func (m *DNSStatsM) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			"query_domain": newFString("The queried domain name from the DNS request"),
		},
	}
}
