...
func (m *Measurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Tags: map[string]interface{}{
			...
			"telemetry_auto_version":      &inputs.TagInfo{Desc: "Version"},
			"telemetry_sdk_language":      &inputs.TagInfo{Desc: "Language"},
			"telemetry_sdk_name":          &inputs.TagInfo{Desc: "SDK Name"},
			"telemetry_sdk_version":       &inputs.TagInfo{Desc: "SDK Version"},
			...
			"process_runtime_version":     &inputs.TagInfo{Desc: "JVM Pool Runtime Version"},
			"process_runtime_name":        &inputs.TagInfo{Desc: "JVM Pool Runtime Name"},
			"process_runtime_description": &inputs.TagInfo{Desc: "Process Runtime Description"},
			"process_executable_path":     &inputs.TagInfo{Desc: "Executable File Path"},
			"process_command_line":        &inputs.TagInfo{Desc: "Process Command Line"},
			"container_id":                &inputs.TagInfo{Desc: "Container ID"},
			"os_description":              &inputs.TagInfo{Desc: "OS Version"},
