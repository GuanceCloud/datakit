...
func (ipt *Input) GetENVDoc() []*inputs.ENVInfo {
	...
	infos := []*inputs.ENVInfo{
		...
		{FieldName: "CompatibleDdTrace", ENVName: "COMPATIBLE_DDTRACE", Type: doc.Boolean, Default: `false`, Desc: "Convert trace_id to decimal, compatible with DDTrace", DescZh: "将 trace_id 转成 10 进制，兼容 DDTrace"},
		...
		{FieldName: "TracingMetricDisableGlobalHostTags", Type: doc.Boolean, Default: `false`, Desc: "Disable add global host tags to OTEL metrics", DescZh: "禁止追加全局主机 tag 到 OTEL 指标数据上"},
		...
		{FieldName: "TracingMetricTagWhitelist", Type: doc.JSON, Example: "`'[\"tag_a\", \"tag_b\"]'`", Desc: "Whitelist of tags in the metric: `tracing_metrics`", DescZh: "指标集 `tracing_metrics` 中标签的白名单"},
		...
		{FieldName: "HTTPConfig", ENVName: "HTTP", Type: doc.JSON, Example: "`'{\"enable\":true, \"http_status_ok\": 200, \"trace_api\": \"/otel/v1/traces\", \"metric_api\": \"/otel/v1/metrics\", \"logs_api\": \"/otel/v1/logs\"}'`", Desc: "HTTP agent config", DescZh: "代理 HTTP 配置"},
