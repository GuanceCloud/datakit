	...
	cases := []struct {
	...
	}{
		{
			...
			envs: map[string]string{
				...
				"ENV_INPUT_OTEL_GRPC":                                    `{"addr": "127.0.0.1:4317", "max_payload": 12345}`,
				"ENV_INPUT_OTEL_EXPECTED_HEADERS":                        `{"ex_version": "1.2.3", "ex_name": "env_resource_name"}`,
				"ENV_INPUT_OTEL_CLEAN_MESSAGE":                           `0`,
				"ENV_INPUT_OTEL_TRACING_METRIC_DISABLE_GLOBAL_HOST_TAGS": `true`,
			},
			expected: &Input{
				...
				GRPCConfig:                         &gRPC{Address: "127.0.0.1:4317", MaxPayload: 12345},
				ExpectedHeaders:                    map[string]string{"ex_version": "1.2.3", "ex_name": "env_resource_name"},
				CleanMessage:                       false,
				TracingMetricDisableGlobalHostTags: true,
			},
		},
	}
