...
// storage, OR can be embedded by other protocols that transfer OTLP traces data
...
func (x *ResourceSpans) GetResource() *resource.Resource {
	if x != nil {
		return x.Resource
	}
	return nil
...
func (x *ScopeSpans) GetScope() *common.InstrumentationScope {
	if x != nil {
		return x.Scope
	}
	return nil
...
func (x *Span_Event) GetAttributes() []*common.KeyValue {
	if x != nil {
		return x.Attributes
	}
	return nil
...
func (x *Span_Link) GetAttributes() []*common.KeyValue {
	if x != nil {
		return x.Attributes
	}
	return nil
...
var file_opentelemetry_proto_trace_v1_trace_proto_rawDesc = []byte{
	...
	0x01, 0x10, 0x02, 0x42, 0xb4, 0x01, 0x0a, 0x1f, 0x69, 0x6f, 0x2e, 0x6f, 0x70, 0x65, 0x6e, 0x74,
	...
	0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x64, 0x67, 0x69, 0x74, 0x6c, 0x61, 0x62, 0x2e, 0x6a, 0x69,
	...
	0x6b, 0x69, 0x74, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x70, 0x6c, 0x75,
	0x67, 0x69, 0x6e, 0x73, 0x2f, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x73, 0x2f, 0x6f, 0x70, 0x65, 0x6e,
	0x74, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x2f, 0x63, 0x6f, 0x6d, 0x70, 0x69, 0x6c,
	0x65, 0x64, 0x2f, 0x76, 0x31, 0x2f, 0x74, 0x72, 0x61, 0x63, 0x65, 0xaa, 0x02, 0x1c, 0x4f, 0x70,
...
var file_opentelemetry_proto_trace_v1_trace_proto_goTypes = []interface{}{
	...
	(*resource.Resource)(nil),           // 9: opentelemetry.proto.resource.v1.Resource
	(*common.InstrumentationScope)(nil), // 10: opentelemetry.proto.common.v1.InstrumentationScope
	(*common.KeyValue)(nil),             // 11: opentelemetry.proto.common.v1.KeyValue
}
