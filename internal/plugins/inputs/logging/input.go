	...
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			"__docid": &inputs.FieldInfo{
				...
				Desc:     "Built-in extension fields added by the central system. The unique identifier for a log document, typically used for sorting and viewing details"},
			"__namespace": &inputs.FieldInfo{
				DataType: inputs.String,
				Unit:     inputs.UnknownUnit,
				Desc:     "Built-in extension fields added by the central system. The unique identifier for a log document dataType."},
			"__truncated_id": &inputs.FieldInfo{
				DataType: inputs.String,
				Unit:     inputs.UnknownUnit,
				Desc:     "Built-in extension fields added by the central system. If the log is particularly large (usually exceeding 1M in size), the central system will split it and add three fields: __truncated_id, __truncated_count, and __truncated_number to define the splitting scenario. The __truncated_id field represents the unique identifier for the split log."},
			...
			"date_ns": &inputs.FieldInfo{
				...
				Desc:     "Built-in extension fields added by the central system. The date_ns field is set to the millisecond part of the time when the log is collected by the collector by default. Its maximum value is 1.0E+6 and its unit is nanoseconds. It is typically used for sorting."},
			...
			"df_metering_size": &inputs.FieldInfo{
				DataType: inputs.Int,
				Unit:     inputs.UnknownUnit,
				Desc:     "Built-in extension fields added by the central system. The df_metering_size field is used for logging cost statistics."},
		},
	}
}
