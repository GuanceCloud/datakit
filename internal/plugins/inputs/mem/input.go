...
func (ipt *Input) collect(ptTS int64) error {
	...
	kvs = kvs.Add("total", vm.Total)
	kvs = kvs.Add("available", vm.Available)
	kvs = kvs.Add("used", vm.Used)
	...
	case "darwin":
		...
		kvs = kvs.Add("free", vm.Free)
		kvs = kvs.Add("inactive", vm.Inactive)
		kvs = kvs.Add("wired", vm.Wired)
	case "linux":
		kvs = kvs.Add("active", vm.Active)
		kvs = kvs.Add("buffered", vm.Buffers)
		kvs = kvs.Add("cached", vm.Cached)
		kvs = kvs.Add("commit_limit", vm.CommitLimit)
		kvs = kvs.Add("committed_as", vm.CommittedAS)
		kvs = kvs.Add("dirty", vm.Dirty)
		kvs = kvs.Add("free", vm.Free)
		kvs = kvs.Add("high_free", vm.HighFree)
		kvs = kvs.Add("high_total", vm.HighTotal)
		kvs = kvs.Add("huge_pages_free", vm.HugePagesFree)
		kvs = kvs.Add("huge_pages_size", vm.HugePageSize)
		kvs = kvs.Add("huge_pages_total", vm.HugePagesTotal)
		kvs = kvs.Add("inactive", vm.Inactive)
		kvs = kvs.Add("low_free", vm.LowFree)
		kvs = kvs.Add("low_total", vm.LowTotal)
		kvs = kvs.Add("mapped", vm.Mapped)
		kvs = kvs.Add("page_tables", vm.PageTables)
		kvs = kvs.Add("shared", vm.Shared)
		kvs = kvs.Add("slab", vm.Slab)
		kvs = kvs.Add("sreclaimable", vm.SReclaimable)
		kvs = kvs.Add("sunreclaim", vm.SUnreclaim)
		kvs = kvs.Add("swap_cached", vm.SwapCached)
		kvs = kvs.Add("swap_free", vm.SwapFree)
		kvs = kvs.Add("swap_total", vm.SwapTotal)
		kvs = kvs.Add("vmalloc_chunk", vm.VMallocChunk)
		kvs = kvs.Add("vmalloc_total", vm.VMallocTotal)
		kvs = kvs.Add("vmalloc_used", vm.VMallocUsed)
		kvs = kvs.Add("write_back_tmp", vm.WritebackTmp)
		kvs = kvs.Add("write_back", vm.Writeback)
	}
