...
//nolint:lll,goconst,funlen // vSphere measurement metadata contains intentionally long repeated literals.
package vsphere
...
var (
	vsphereClusterMetricTaggedby   = []string{"host", "dcname", "cluster_name", "moid"}
	vsphereDatastoreMetricTaggedby = []string{"host", "dcname", "moid", "dsname"}
	vsphereHostMetricTaggedby      = []string{"host", "dcname", "cluster_name", "esx_hostname", "instance", "moid"}
	vsphereVMMetricTaggedby        = []string{"host", "dcname", "cluster_name", "esx_hostname", "instance", "moid", "vm_name"}

	vsphereClusterObjectTaggedby   = []string{"host", "dcname", "cluster_name", "name"}
	vsphereDatastoreObjectTaggedby = []string{"host", "dcname", "dsname", "name", "url", "type"}
	vsphereHostObjectTaggedby      = []string{"host", "dcname", "cluster_name", "esx_hostname", "name", "vendor", "model", "cpu_model", "connection_state", "in_maintenance_mode", "power_state"}
	vsphereVMObjectTaggedby        = []string{"host", "dcname", "cluster_name", "esx_hostname", "vm_name", "name", "guest_full_name", "host_name", "ip_address", "connection_state", "template", "power_state"}

	vsphereEventTaggedby = []string{"status", "host", "event_type_id", "object_name", "user_name", "resource_type", "dcname", "cluster_name", "esx_hostname", "vm_name", "dsname"}
)
...
func (m *Measurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		Name:   "vsphere_cpu",
		Desc:   "vSphere CPU metrics collected from the vSphere performance API.",
		DescZh: "从 vSphere 性能 API 采集的 CPU 指标。",
		Cat:    point.Metric,
...
func (m *clusterMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Desc:   "Performance metrics for vSphere clusters collected from vCenter counters.",
		DescZh: "从 vCenter 性能计数器采集的 vSphere 集群性能指标。",
		Cat:    point.Metric,
		Fields: normalizeVSphereFieldsMap(map[string]interface{}{
			...
			"cpu_usagemhz_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.FrequencyMHz,
				Desc: "CPU usage, as measured in megahertz.",
			},

			"mem_consumed_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
...
func (m *datastoreMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Desc:   "Performance metrics for vSphere datastores collected from vCenter counters.",
		DescZh: "从 vCenter 性能计数器采集的 vSphere 数据存储性能指标。",
		Cat:    point.Metric,
		Fields: normalizeVSphereFieldsMap(map[string]interface{}{
			"datastore_busResets_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of SCSI-bus reset commands issued.",
			},

			"datastore_commandsAborted_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of SCSI commands aborted.",
			},

			"datastore_numberReadAveraged_average": &inputs.FieldInfo{
			...
			"datastore_numberWriteAveraged_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Average number of write commands issued per second to the datastore during the collection interval.",
			},

			"datastore_throughput_contention.avg": &inputs.FieldInfo{
			...
			"datastore_throughput_usage_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.KBytesPerSec,
				Desc: "The current bandwidth usage for the datastore or LUN.",
			},

			"disk_busResets_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of SCSI-bus reset commands issued.",
			},

			"disk_capacity_contention_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent,
				Desc: "The amount of storage capacity overcommitment for the entity, measured in percent.",
			},

			"disk_capacity_latest": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
				Desc: "Configured size of the datastore.",
			},

			"disk_capacity_provisioned_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
				Desc: "Provisioned size of the entity.",
			},

			"disk_capacity_usage.avg": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
				Desc: "The amount of storage capacity currently being consumed by or on the entity.",
			},

			"disk_numberReadAveraged_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Average number of read commands issued per second to the datastore.",
			},

			"disk_numberWriteAveraged_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Average number of write commands issued per second to the datastore.",
			},

			"disk_provisioned_latest": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
			...
			"disk_unshared_latest": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
				Desc: "Amount of space associated exclusively with a virtual machine.",
			},

			"disk_used_latest": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
		...
		}, vsphereDatastoreMetricTaggedby),
		Tags: map[string]interface{}{
			"host":   &inputs.TagInfo{Desc: "The host of the vCenter"},
			"dcname": &inputs.TagInfo{Desc: "`Datacenter` name"},
			"moid":   &inputs.TagInfo{Desc: "The managed object id"},
...
func (m *vmMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: normalizeVSphereFieldsMap(map[string]interface{}{
			...
			"cpu_capacity_demand_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.FrequencyMHz,
				Desc: "The amount of CPU resources a virtual machine would use if there were no CPU contention or CPU limit.",
			},

			"cpu_capacity_usage_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.Percent,
				Desc: "CPU usage as a percent during the interval.",
			},

			"cpu_capacity_contention_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent,
				Desc: "Percent of time the virtual machine is unable to run because it is contending for access to the physical CPU(s).",
			},

			"datastore_maxTotalLatency_latest": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.DurationMS,
			...
			"datastore_read_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.KBytesPerSec,
				Desc: "Rate of reading data from the datastore.",
			},

			"datastore_totalReadLatency_average": &inputs.FieldInfo{
			...
			"datastore_totalWriteLatency_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.DurationMS,
				Desc: "Average amount of time for a write operation from the datastore.",
			},

			"datastore_write_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.KBytesPerSec,
			...
			"disk_commands_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of SCSI commands issued",
			},

			"disk_commandsAborted_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of SCSI commands aborted.",
			},

			"disk_commandsAveraged_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Average number of SCSI commands issued per second.",
			},

			"disk_maxTotalLatency_latest": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.DurationMS,
				Desc: "Highest latency value across all disks used by the host.",
			},

			"disk_numberRead_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
			...
			"disk_numberWrite_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
			...
			"disk_provisioned_latest": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
				Desc: "Amount of storage provisioned for the virtual machine.",
			},

			"disk_read_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.KBytesPerSec,
			...
			"disk_unshared_latest": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
				Desc: "Amount of storage used exclusively by the virtual machine.",
			},

			"disk_usage_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.KBytesPerSec,
			...
			"mem_shared_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeKB,
			...
			"mem_swaptarget_average": &inputs.FieldInfo{
				DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeKB,
			...
			"mem_vmmemctltarget_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
			...
			"mem_zero_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
			...
			"mem_zipSaved_latest": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
				Desc: "Memory saved due to memory zipping.",
			},

			"mem_zipped_latest": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
				Desc: "Amount of guest memory currently stored in compressed form by ESXi memory zipping.",
			},

			"mem_capacity_usage_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
				Desc: "Amount of physical memory actively used.",
			},

			"mem_capacity_contention_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.Percent,
				Desc: "Percentage of time VMs are waiting to access swapped, compressed or ballooned memory.",
			},

			"net_broadcastRx_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of broadcast packets received.",
			},

			"net_broadcastTx_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of broadcast packets transmitted.",
			},

			"net_bytesRx_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.KBytesPerSec,
				Desc: "Average amount of data received per second.",
			},

			"net_bytesTx_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.KBytesPerSec,
				Desc: "Average amount of data transmitted per second.",
			},

			"net_droppedRx_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of received packets dropped.",
			},

			"net_droppedTx_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of transmitted packets dropped.",
			},

			"net_multicastRx_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of multicast packets received.",
			},

			"net_multicastTx_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of multicast packets transmitted.",
			},

			"net_packetsRx_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of packets received.",
			},

			"net_packetsTx_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount,
				Desc: "Number of packets transmitted.",
			},

			"net_pnicBytesRx_average": &inputs.FieldInfo{
...
func (m *hostMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		Name:   "vsphere_host",
		Desc:   "Performance metrics for ESXi hosts collected from vCenter counters.",
		DescZh: "从 vCenter 性能计数器采集的 ESXi 主机性能指标。",
		Cat:    point.Metric,
		Fields: normalizeVSphereFieldsMap(map[string]interface{}{
			"cpu_costop_sum": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.DurationMS,
			...
			"mem_llSwapIn_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
				Desc: "Amount of memory swapped-in from host cache.",
			},

			"mem_llSwapOut_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
				Desc: "Amount of memory swapped-out to host cache.",
			},

			"mem_lowfreethreshold_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
			...
			"mem_totalCapacity_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeMB,
			...
			"mem_unreserved_average": &inputs.FieldInfo{
				DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB,
...
func normalizeVSphereFieldsMap(fields map[string]interface{}, taggedby []string) map[string]interface{} {
	for name, field := range fields {
		info, ok := field.(*inputs.FieldInfo)
		if !ok {
			continue
		}
		normalizeVSphereField(name, info)
		info.Taggedby = cloneVSphereTaggedby(taggedby)
	}

	return fields
}

func addVSphereTaggedby(fields map[string]interface{}, taggedby []string) map[string]interface{} {
...
func cloneVSphereTaggedby(taggedby []string) []string {
	if len(taggedby) == 0 {
		return nil
	}

	cloned := make([]string, len(taggedby))
	copy(cloned, taggedby)
	return cloned
}

func normalizeVSphereField(name string, info *inputs.FieldInfo) {
	desc := strings.ToLower(info.Desc)

	switch name {
	case "cpu_usagemhz_average",
		"cpu_demand_average",
		...
		info.Unit = inputs.FrequencyMHz
	case "cpu_capacity_usage_average", "mem_capacity_contention_average":
		info.Unit = inputs.Percent
	case "datastore_datastoreReadBytes_latest", "datastore_datastoreWriteBytes_latest":
		info.Unit = inputs.SizeByte
	case "net_unknownProtos_sum":
		info.Unit = inputs.NCount
	case "datastore_datastoreIops_average":
		info.Unit = inputs.NCount
	case "mem_state_latest":
		info.Unit = inputs.NoUnit
	}

	if info.Unit == inputs.SizeKB && isVSphereKBRate(desc) {
		info.Unit = inputs.KBytesPerSec
	}

	if info.Unit != inputs.UnknownUnit {
		return
	}

	switch {
	case strings.Contains(desc, "megahertz"), strings.Contains(desc, "cpu resources"), strings.Contains(desc, "in mhz"):
		info.Unit = inputs.FrequencyMHz
	case strings.Contains(desc, "joule"):
		info.Unit = inputs.Joule
	case strings.Contains(desc, "power usage"):
		info.Unit = inputs.Watt
	case strings.Contains(desc, "latency"), strings.Contains(desc, "time spent in the vmkernel queue"):
		info.Unit = inputs.DurationMS
	case strings.Contains(desc, "metric for the read workload model"), strings.Contains(desc, "metric for the write workload model"),
		strings.Contains(desc, "metric for read workload model"), strings.Contains(desc, "metric for write workload model"):
		info.Unit = inputs.NoUnit
	case strings.Contains(desc, "outstanding"), strings.Contains(desc, "queue depth"), strings.Contains(desc, "sample count"),
		strings.Contains(desc, "heartbeats"), strings.Contains(desc, "file descriptors"), strings.Contains(desc, "shares of the system resource group"):
		info.Unit = inputs.NCount
	case strings.Contains(desc, "per second"), strings.Contains(desc, "number of "), strings.Contains(desc, "i/o rate"):
		info.Unit = inputs.NCount
	}
}

func isVSphereKBRate(desc string) bool {
	return strings.Contains(desc, "per second") ||
		strings.Contains(desc, "kilobytes read") ||
		strings.Contains(desc, "kilobytes written") ||
		strings.Contains(desc, "rate of ") ||
		strings.Contains(desc, "bandwidth usage") ||
		strings.Contains(desc, "i/o rate") ||
		strings.Contains(desc, "network traffic")
}
...
func (*hostObject) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: addVSphereTaggedby(map[string]interface{}{
...
func (*vmObject) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Tags: map[string]interface{}{
			...
			"cluster_name":  &inputs.TagInfo{Desc: "Cluster name"},
			"esx_hostname":  &inputs.TagInfo{Desc: "The name of the ESXi host"},
			"vm_name":       &inputs.TagInfo{Desc: "The name of the virtual machine resource"},
		...
		Fields: addVSphereTaggedby(map[string]interface{}{
			...
			MemorySizeMB:     &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeMB, Desc: "Memory size of the virtual machine, in megabytes."},
		}, vsphereVMObjectTaggedby),
	}
}
...
func (*datastoreObject) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Tags: map[string]interface{}{
			"host":   &inputs.TagInfo{Desc: "The host of the vCenter"},
			"dcname": &inputs.TagInfo{Desc: "`Datacenter` name"},
			"dsname": &inputs.TagInfo{Desc: "The datastore resource name"},
		...
		}, vsphereDatastoreObjectTaggedby),
	}
}
...
func (*eventMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Tags: map[string]interface{}{
			...
			"dcname":       &inputs.TagInfo{Desc: "`Datacenter` name"},
			"cluster_name": &inputs.TagInfo{Desc: "Cluster name when the event belongs to a cluster, host, or VM"},
			"esx_hostname": &inputs.TagInfo{Desc: "The ESXi host name when the event belongs to a host or VM"},
			"vm_name":      &inputs.TagInfo{Desc: "The virtual machine name when the event belongs to a VM"},
			"dsname":       &inputs.TagInfo{Desc: "The datastore name when the event belongs to a datastore"},
		},
		Fields: addVSphereTaggedby(map[string]interface{}{
			...
			ChangeTag: &inputs.FieldInfo{DataType: inputs.String, Type: inputs.UnknownType, Unit: inputs.NoUnit, Desc: "User-defined operation tag used to correlate the event and its side effects."},
