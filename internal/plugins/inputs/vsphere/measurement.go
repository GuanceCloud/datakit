...
func (m *vmMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			"disk_provisioned_latest":                 &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB, Desc: "Amount of storage provisioned for the virtual machine."},
			...
			"disk_unshared_latest":                    &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB, Desc: "Amount of storage used exclusively by the virtual machine."},
			...
			"disk_used_latest":                        &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeKB, Desc: "Amount of datastore space currently used by the virtual machine."},
