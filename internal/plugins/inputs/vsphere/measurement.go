...
func (m *datastoreMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			"disk_numberReadAveraged_average":       &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.UnknownUnit, Desc: "Average number of read commands issued per second to the datastore."},
...
func (*vmObject) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			MaxCPUUsage:      &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.UnknownUnit, Desc: "Current upper-bound on CPU usage."},
			MaxMemoryUsage:   &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.UnknownUnit, Desc: "Current upper-bound on memory usage."},
...
func (*clusterObject) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			TotalCPU:          &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.UnknownUnit, Desc: "Aggregated CPU resources of all hosts, in MHz."},
			...
			EffectiveCPU:      &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Effective CPU resources (in MHz) available to run virtual machines."},
...
func (*eventMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			Message:  &inputs.FieldInfo{DataType: inputs.String, Type: inputs.UnknownType, Unit: inputs.UnknownUnit, Desc: "A formatted text message describing the event. The message may be localized."},
			ChainID:  &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.UnknownUnit, Desc: "The parent or group ID."},
			EventKey: &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.UnknownUnit, Desc: "The event ID."},
		},
	}
}
