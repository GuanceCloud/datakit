...
func TestInput_parseBigData(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []string{
				"redis_bigkey,db_name=0,for=bar key=\"keySlice2999\",key_type=\"string\",message=\"big key  key: keySlice2999 key_type: string value_length: 47984\",status=\"info\",value_length=47984i",
				"redis_bigkey,db_name=0,for=bar key=\"keyZSet2999\",key_type=\"zset\",message=\"big key  key: keyZSet2999 key_type: zset value_length: 3001\",status=\"info\",value_length=3001i",
				"redis_bigkey,db_name=0,for=bar key=\"myhash\",key_type=\"hash\",message=\"big key  key: myhash key_type: hash value_length: 2\",status=\"info\",value_length=2i",
				"redis_bigkey,db_name=0,for=bar keys_sampled=3006i,message=\"big key  keys_sampled: 3006\",status=\"info\"",
			},
			wantErr: false,
		},

		{
			...
			want: []string{
				"redis_bigkey,db_name=0,for=bar key=\"keyname\",key_type=\"hash\",message=\"big key  key: keyname key_type: hash value_length: 2\",status=\"info\",value_length=2i",
				"redis_bigkey,db_name=0,for=bar key=\"mykey\",key_type=\"string\",message=\"big key  key: mykey key_type: string value_length: 13\",status=\"info\",value_length=13i",
				"redis_bigkey,db_name=0,for=bar keys_sampled=2i,message=\"big key  keys_sampled: 2\",status=\"info\"",
			},
			wantErr: false,
		},

		{
			...
			want: []string{
				"redis_bigkey,db_name=0,for=bar key=\"wo18127.0.0.1:6379\",key_type=\"string\",message=\"big key  key: wo18127.0.0.1:6379 key_type: string value_length: 288\",status=\"info\",value_length=288i",
				"redis_bigkey,db_name=0,for=bar keys_sampled=6i,message=\"big key  keys_sampled: 6\",status=\"info\"",
			},
			wantErr: false,
		},

		{
			...
			want: []string{
				"redis_bigkey,db_name=0,for=bar key=\"wo19\",key_type=\"string\",message=\"big key  key: wo19 key_type: string value_length: 358\",status=\"info\",value_length=358i",
				"redis_bigkey,db_name=0,for=bar keys_sampled=20i,message=\"big key  keys_sampled: 20\",status=\"info\"",
			},
			wantErr: false,
		},
	}
