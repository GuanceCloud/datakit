...
func (cs *caseSpec) checkPoint(pts []*point.Point) error {
	for _, pt := range pts {
		...
		case measureuemtRedisBigKey:
			...
			cs.mCount[measureuemtRedisBigKey] = struct{}{}

		case measureuemtRedisClient:
			opts = append(opts, cs.optsRedisClient...)
			opts = append(opts, inputs.WithDoc(&clientLoggingMeasurement{}))
			...
			cs.mCount[measureuemtRedisClient] = struct{}{}

		case measureuemtRedisCluster:
			...
			cs.mCount[measureuemtRedisCluster] = struct{}{}

		case measureuemtRedisCommandStat:
			...
			cs.mCount[measureuemtRedisCommandStat] = struct{}{}

		case measureuemtRedisDB:
			...
			cs.mCount[measureuemtRedisDB] = struct{}{}

		case measurementRedisInfo:
			...
			cs.mCount[measurementRedisInfo] = struct{}{}

		case measureuemtRedisReplica:
			...
			cs.mCount[measureuemtRedisReplica] = struct{}{}

		case measureuemtRedisSlowLog:
			// TODO:
