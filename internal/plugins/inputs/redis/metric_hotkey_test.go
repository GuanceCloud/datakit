...
func TestInput_parseHotData(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: []string{
				"redis_hotkey,db_name=0,for=bar key=\"/data/p/net.p\",key_count=5i,message=\"hot key  key: /data/p/net.p key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice15\",key_count=5i,message=\"hot key  key: keySlice15 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice3\",key_count=5i,message=\"hot key  key: keySlice3 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice30\",key_count=5i,message=\"hot key  key: keySlice30 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice35\",key_count=5i,message=\"hot key  key: keySlice35 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice46\",key_count=6i,message=\"hot key  key: keySlice46 key_count: 6\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice48\",key_count=5i,message=\"hot key  key: keySlice48 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice53\",key_count=5i,message=\"hot key  key: keySlice53 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice56\",key_count=5i,message=\"hot key  key: keySlice56 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice57\",key_count=5i,message=\"hot key  key: keySlice57 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice65\",key_count=5i,message=\"hot key  key: keySlice65 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice70\",key_count=5i,message=\"hot key  key: keySlice70 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice78\",key_count=5i,message=\"hot key  key: keySlice78 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice8\",key_count=5i,message=\"hot key  key: keySlice8 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice84\",key_count=5i,message=\"hot key  key: keySlice84 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice91\",key_count=5i,message=\"hot key  key: keySlice91 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar keys_sampled=102i,message=\"hot key  keys_sampled: 102\",status=\"info\"",
			},
			wantErr: false,
		},

		{
			...
			want: []string{
				"redis_hotkey,db_name=0,for=bar key=\"keySlice0\",key_count=6i,message=\"hot key  key: keySlice0 key_count: 6\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2108\",key_count=4i,message=\"hot key  key: keySlice2108 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2182\",key_count=4i,message=\"hot key  key: keySlice2182 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2218\",key_count=4i,message=\"hot key  key: keySlice2218 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2275\",key_count=4i,message=\"hot key  key: keySlice2275 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2328\",key_count=4i,message=\"hot key  key: keySlice2328 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2340\",key_count=4i,message=\"hot key  key: keySlice2340 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2462\",key_count=4i,message=\"hot key  key: keySlice2462 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2669\",key_count=4i,message=\"hot key  key: keySlice2669 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2691\",key_count=4i,message=\"hot key  key: keySlice2691 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2791\",key_count=4i,message=\"hot key  key: keySlice2791 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2796\",key_count=4i,message=\"hot key  key: keySlice2796 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2803\",key_count=4i,message=\"hot key  key: keySlice2803 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2838\",key_count=4i,message=\"hot key  key: keySlice2838 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice2943\",key_count=4i,message=\"hot key  key: keySlice2943 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"keySlice33\",key_count=4i,message=\"hot key  key: keySlice33 key_count: 4\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar keys_sampled=3006i,message=\"hot key  keys_sampled: 3006\",status=\"info\"",
			},
			wantErr: false,
		},

		{
			...
			want: []string{
				"redis_hotkey,db_name=0,for=bar key=\"wo0\",key_count=5i,message=\"hot key  key: wo0 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"wo11\",key_count=1i,message=\"hot key  key: wo11 key_count: 1\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar keys_sampled=20i,message=\"hot key  keys_sampled: 20\",status=\"info\"",
			},
			wantErr: false,
		},

		{
			...
			want: []string{
				"redis_hotkey,db_name=0,for=bar key=\"wo0\",key_count=5i,message=\"hot key  key: wo0 key_count: 5\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar key=\"wo12\",key_count=1i,message=\"hot key  key: wo12 key_count: 1\",status=\"info\"",
				"redis_hotkey,db_name=0,for=bar keys_sampled=20i,message=\"hot key  keys_sampled: 20\",status=\"info\"",
			},
			wantErr: false,
		},
