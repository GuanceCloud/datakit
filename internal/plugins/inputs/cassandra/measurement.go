...
func (m *CassandraMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		Name:   "cassandra",
		Cat:    point.Metric,
		Desc:   "Cassandra node metrics from JMX, Jolokia, and exporter payloads, covering storage, compaction, caches, thread pools, and client request activity.",
		DescZh: "从 JMX、Jolokia 和导出器数据中采集的 Cassandra 节点指标，涵盖存储、压缩、缓存、线程池和客户端请求活动。",
		Fields: map[string]interface{}{
			...
			"bloom_filter_false_ratio":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.PercentDecimal, Desc: "The ratio of Bloom filter false positives to total checks."},
			...
			"compression_ratio":                               &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.PercentDecimal, Desc: "Compression ratio for all SSTables, reported as compressed size divided by original size."},
			...
			"db_droppable_tombstone_ratio":                    &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.PercentDecimal, Desc: "Estimated droppable tombstone ratio as a value from 0 to 1."},
			...
			"key_cache_hit_rate":                              &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.PercentDecimal, Desc: "Key cache hit rate as a value from 0 to 1."},
			...
			"metrics_count":                                   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Generic Cassandra metric count reported by the Jolokia metric path."},
			"metrics_value":                                   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Generic Cassandra metric value reported by the Jolokia metric path."},
			"metrics_95th_percentile":                         &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Generic Cassandra metric 95th percentile reported by the Jolokia metric path."},
			"metrics_75th_percentile":                         &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Generic Cassandra metric 75th percentile reported by the Jolokia metric path."},
			"metrics_one_minute_rate":                         &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Generic Cassandra metric one-minute rate reported by the Jolokia metric path."},
		},
