...
func TestInput_sendRequestToDW(t *testing.T) {
    ...
    "language": "python",
    "tags_profiler": "format:pprof,sampleRate:100,spyName:pyspy,name:python-pyro-demo,language:python,from:1734602990,until:1734603000",
    "start": "2024-12-19T10:09:50Z",
	...
	u, err := url.Parse("http://localhost:4040/ingest?name=python-pyro-demo&from=1734437880&until=1734437890&format=pprof&sampleRate=100&spyName=pyspy")
	if err != nil {
		t.Fatal(err)
	}
	...
	pbOBJ := &rum.RequestPB{
		...
		Body:       buf.Bytes(),
		FormValues: QueryToPBForms(u.Query()),
	}
