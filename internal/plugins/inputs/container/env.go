...
func (ipt *Input) GetENVDoc() []*inputs.ENVInfo {
	...
	infos := []*inputs.ENVInfo{
		...
		{FieldName: "KeepExistPrometheusMetricName", Type: doc.Boolean, Default: "false", Desc: `Whether to keep the raw field names for Prometheus, see [Kubernetes Prometheus doc](kubernetes-prom.md#measurement-and-tags`, DescZh: `是否保留原始的 Prometheus 字段名，详见 [Kubernetes Prometheus doc](kubernetes-prom.md#measurement-and-tags)`},
