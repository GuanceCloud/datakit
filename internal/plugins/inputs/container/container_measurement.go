...
func (*containerMetric) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			"cpu_usage_base_request":        &inputs.FieldInfo{DataType: inputs.Float, Unit: inputs.Percent, Desc: "The CPU usage based on the CPU request (percentage) (only supported in Kubernetes)."},
			...
			"cpu_request_millicores":        &inputs.FieldInfo{DataType: inputs.Int, Unit: inputs.Millicores, Desc: "The CPU request of the container, measured in milli-cores (only supported in Kubernetes)."},
			...
			"mem_used_percent_base_request": &inputs.FieldInfo{DataType: inputs.Float, Unit: inputs.Percent, Desc: "The memory usage percentage based on the memory request (only supported in Kubernetes)."},
			"mem_limit":                     &inputs.FieldInfo{DataType: inputs.Int, Unit: inputs.SizeByte, Desc: "The memory limit of the container."},
			"mem_request":                   &inputs.FieldInfo{DataType: inputs.Int, Unit: inputs.SizeByte, Desc: "The memory request of the container (only supported in Kubernetes)."},
...
func (*containerLog) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			"status":          &inputs.FieldInfo{DataType: inputs.String, Unit: inputs.UnknownUnit, Desc: "The status of the logging, dafault is `info`."},
