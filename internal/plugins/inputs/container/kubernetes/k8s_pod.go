...
func (*PodMetric) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		DescZh: "Kubernetes Pod 指标，记录 Pod 就绪、重启、CPU、内存、网络和临时存储使用情况。",
		Cat:    point.Metric,
		...
		Fields: map[string]interface{}{
			"ready":                             &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Describes whether the pod is ready to serve requests."},
			"restarts":                          &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "The number of times the container has been restarted."},
			"cpu_usage":                         &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The total CPU usage across all containers in this Pod."},
			"cpu_usage_millicores":              &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.Millicores, Desc: "The total CPU usage (in millicores) averaged over the sample window for all containers."},
			"cpu_usage_base100":                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The normalized CPU usage, with a maximum of 100%."},
			"cpu_usage_base_limit":              &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The normalized CPU usage, with a maximum of 100%, based on the CPU limit."},
			"cpu_usage_base_request":            &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The normalized CPU usage, with a maximum of 100%, based on the CPU request."},
			"cpu_number":                        &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "The total number of CPUs on the node where the Pod is running."},
			"cpu_limit_millicores":              &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.Millicores, Desc: "The total CPU limit (in millicores) across all containers in this Pod. Note: This value is the sum of all container limit values, as Pods do not have a direct limit value."},
			"cpu_request_millicores":            &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.Millicores, Desc: "The total CPU request (in millicores) across all containers in this Pod.  Note: This value is the sum of all container request values, as Pods do not have a direct request value."},
			"mem_usage":                         &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total memory usage of all containers in this Pod."},
			"mem_rss":                           &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total RSS memory usage of all containers in this Pod, which is not supported by metrics-server."},
			"mem_used_percent":                  &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The percentage of memory usage based on the host machine’s total memory capacity."},
			"mem_used_percent_base_limit":       &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The percentage of memory usage based on the memory limit."},
			"mem_used_percent_base_request":     &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The percentage of memory usage based on the memory request."},
			"mem_capacity":                      &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total memory capacity of the host machine."},
			"mem_limit":                         &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total memory limit across all containers in this Pod.  Note: This value is the sum of all container limit values, as Pods do not have a direct limit value."},
			"mem_request":                       &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total memory request across all containers in this Pod.  Note: This value is the sum of all container request values, as Pods do not have a direct request value."},
			"network_bytes_rcvd":                &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Cumulative count of bytes received."},
			"network_bytes_sent":                &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Cumulative count of bytes transmitted."},
			"ephemeral_storage_used_bytes":      &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The bytes used for a specific task on the filesystem."},
			"ephemeral_storage_available_bytes": &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The storage space available (bytes) for the filesystem."},
			"ephemeral_storage_capacity_bytes":  &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total capacity (bytes) of the filesystems underlying storage."},
			"memory_usage_bytes":                &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The sum of the memory usage of all containers in this Pod (Deprecated use `mem_usage`)."},
			"memory_capacity":                   &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total memory in the host machine (Deprecated use `mem_capacity`)."},
			"memory_used_percent":               &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The percentage usage of the memory (refer from `mem_used_percent`"},
		},
	}
}
...
func (*PodObject) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		DescZh: "Kubernetes Pod 对象信息，记录 Pod 运行状态、容器状态、资源请求限制、节点归属和对象详情。",
		Cat:    point.Object,
		Tags: map[string]interface{}{
		...
		Fields: map[string]interface{}{
			...
			"restarts":                          &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "The number of times the container has been restarted."},
			"ready":                             &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Describes whether the pod is ready to serve requests."},
			"available":                         &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of containers"},
			"cpu_usage":                         &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The total CPU usage across all containers in this Pod."},
			"cpu_usage_millicores":              &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.Millicores, Desc: "The total CPU usage (in millicores) averaged over the sample window for all containers."},
			"cpu_usage_base100":                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The normalized CPU usage, with a maximum of 100%."},
			"cpu_usage_base_limit":              &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The normalized CPU usage, with a maximum of 100%, based on the CPU limit."},
			...
			"mem_limit":                         &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total memory limit across all containers in this Pod.  Note: This value is the sum of all container limit values, as Pods do not have a direct limit value."},
			"mem_request":                       &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total memory request across all containers in this Pod.  Note: This value is the sum of all container request values, as Pods do not have a direct request value."},
			"mem_used_percent_base_100":         &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The percentage usage of the memory (refer from `mem_used_percent`"},
			"memory_usage_bytes":                &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The sum of the memory usage of all containers in this Pod (Deprecated use `mem_usage`)."},
			"memory_capacity":                   &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total memory in the host machine (Deprecated use `mem_capacity`)."},
			"memory_used_percent":               &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.Percent, Desc: "The percentage usage of the memory (refer from `mem_used_percent`"},
			"network_bytes_rcvd":                &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Cumulative count of bytes received."},
