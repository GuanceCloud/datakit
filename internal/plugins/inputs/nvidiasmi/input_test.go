...
func Test_getPts(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "local single card no election",
			ipt: &Input{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := ipt.getPts(tt.args.data, tt.args.server)
