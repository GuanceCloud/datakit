...
func (m *etcdMeasurement) Info() *inputs.MeasurementInfo {
	...
	return &inputs.MeasurementInfo{
		Name:   inputName,
		Cat:    point.Metric,
		Desc:   "etcd server metrics scraped from the Prometheus metrics endpoint, including cluster version, storage, network, Raft, server, Go runtime, and OS file descriptor metrics.",
		DescZh: "从 etcd Prometheus 指标端点采集的 etcd 服务端指标，包括集群版本、存储、网络、Raft、服务端、Go 运行时和操作系统文件描述符指标。",
		Fields: fields,
...
var etcdFields = map[string]interface{}{
	...
	"etcd_debugging_disk_backend_commit_rebalance_duration_seconds":    &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distributions of commit.rebalance called by bboltdb backend."},
	"etcd_debugging_disk_backend_commit_spill_duration_seconds":        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distributions of commit.spill called by bboltdb backend."},
	"etcd_debugging_disk_backend_commit_write_duration_seconds":        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distributions of commit.write called by bboltdb backend."},
	...
	"etcd_debugging_mvcc_db_compaction_last":                           &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.TimestampSec, Desc: "The unix time of the last db compaction. Resets to 0 on start."},
	"etcd_debugging_mvcc_db_compaction_pause_duration_milliseconds":    &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationMS, Desc: "Bucketed histogram of db compaction pause duration."},
	"etcd_debugging_mvcc_db_compaction_total_duration_milliseconds":    &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationMS, Desc: "Bucketed histogram of db compaction total duration."},
	"etcd_debugging_mvcc_db_total_size_in_bytes":                       &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Total size of the underlying database physically allocated in bytes."},
	...
	"etcd_debugging_mvcc_index_compaction_pause_duration_milliseconds": &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationMS, Desc: "Bucketed histogram of index compaction pause duration."},
	...
	"etcd_debugging_mvcc_total_put_size_in_bytes":                      &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total size of put kv pairs seen by this member."},
	...
	"etcd_debugging_snap_save_total_duration_seconds":                  &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The total latency distributions of save called by snapshot."},
	"etcd_debugging_snap_save_marshalling_duration_seconds":            &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The marshaling cost distributions of save called by snapshot."}, //nolint:misspell
	...
	"etcd_disk_backend_commit_duration_seconds":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distributions of commit called by backend."},
	"etcd_disk_backend_defrag_duration_seconds":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distribution of backend defragmentation."},
	"etcd_disk_backend_snapshot_duration_seconds":                      &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distribution of backend snapshots."},
	...
	"etcd_disk_wal_fsync_duration_seconds":                             &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distributions of fsync called by WAL."},
	"etcd_disk_wal_write_bytes_total":                                  &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Total number of bytes written in WAL."},
	...
	"etcd_mvcc_db_total_size_in_bytes":                                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Total size of the underlying database physically allocated in bytes."},
	"etcd_mvcc_db_total_size_in_use_in_bytes":                          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Total size of the underlying database logically in use in bytes."},
	...
	"etcd_mvcc_hash_duration_seconds":                                  &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distribution of storage hash operation."},
	"etcd_mvcc_hash_rev_duration_seconds":                              &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distribution of storage hash by revision operation."},
	...
	"etcd_network_client_grpc_received_bytes_total":                    &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.SizeByte, Desc: "The total number of bytes received from grpc clients."},
	"etcd_network_client_grpc_sent_bytes_total":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.SizeByte, Desc: "The total number of bytes sent to grpc clients."},
	...
	"etcd_network_peer_received_bytes_total":                           &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.SizeByte, Desc: "The total number of bytes received from peers."},
	...
	"etcd_network_peer_round_trip_time_seconds":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "Round-Trip-Time histogram between peers"},
	"etcd_network_peer_sent_bytes_total":                               &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.SizeByte, Desc: "The total number of bytes sent to peers."},
	...
	"etcd_network_snapshot_receive_total_duration_seconds":             &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "Total latency distributions of v3 snapshot receives"},
	...
	"etcd_network_snapshot_send_total_duration_seconds":                &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "Total latency distributions of v3 snapshot sends"},
	"etcd_server_apply_duration_seconds":                               &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distributions of v2 apply called by backend."},
	...
	"etcd_server_quota_backend_bytes":                                  &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Current backend storage quota size in bytes."},
	...
	"etcd_snap_db_fsync_duration_seconds":                              &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distributions of fsyncing .snap.db file"},
	"etcd_snap_db_save_total_duration_seconds":                         &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The total latency distributions of v3 snapshot save"},
	"etcd_snap_fsync_duration_seconds":                                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Histogram, Unit: inputs.DurationSecond, Desc: "The latency distributions of fsync called by snap."},
