...
var dbmMetricMeasurementInfo = &inputs.MeasurementInfo{
	...
	Fields: map[string]interface{}{
		...
		"total_calls":                 &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Count, Unit: inputs.NCount, Desc: "Total number of statement calls aggregated across all pg_stat_statements rows."},
		...
		"delta_shared_blks_written":   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Delta value of shared_blks_written between collection intervals."},
		"delta_local_blks_hit":        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Delta value of local_blks_hit between collection intervals."},
		"delta_local_blks_read":       &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Delta value of local_blks_read between collection intervals."},
		"delta_local_blks_dirtied":    &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Delta value of local_blks_dirtied between collection intervals."},
		"delta_local_blks_written":    &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Delta value of local_blks_written between collection intervals."},
		"delta_temp_blks_read":        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Delta value of temp_blks_read between collection intervals."},
		"delta_temp_blks_written":     &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Delta value of temp_blks_written between collection intervals."},
...
var dbmSampleMeasurementInfo = &inputs.MeasurementInfo{
	...
	Tags: map[string]interface{}{
		"name":              inputs.NewTagInfo("Object identity built from server, optional database_instance, and query_signature:plan_signature."),
		"server":            inputs.NewTagInfo("The server address"),
		...
		"database_type":     inputs.NewTagInfo("The database type. The value is `PostgreSQL`"),
...
var dbmActivityMeasurementInfo = &inputs.MeasurementInfo{
	...
	Fields: map[string]interface{}{
		...
		"duration": &inputs.FieldInfo{
			...
			Desc:     "The query duration derived from query_start and state/sample time.",
		},
		"tx_duration": &inputs.FieldInfo{
			DataType: inputs.Int,
			Type:     inputs.Gauge,
			Unit:     inputs.DurationUS,
			Desc:     "The transaction duration derived from sample time - xact_start.",
		},
		"wait_duration": &inputs.FieldInfo{
			DataType: inputs.Int,
			Type:     inputs.Gauge,
			Unit:     inputs.DurationUS,
			Desc:     "The wait duration derived from sample time - state_change.",
		},
		"blocking_pids": &inputs.FieldInfo{
			DataType: inputs.String,
			Type:     inputs.String,
			Unit:     inputs.UnknownUnit,
			Desc:     "The raw pg_blocking_pids(pid) result for this backend.",
		},
	},
	Tags: map[string]interface{}{
		"server":           inputs.NewTagInfo("The server address"),
