...
// go test -v -timeout 30s -run ^Test_getDeviceID$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/snmp
...
// go test -v -timeout 30s -run ^Test_getDeviceIDTags$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/snmp
