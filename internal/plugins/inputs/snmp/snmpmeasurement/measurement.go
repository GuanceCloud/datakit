...
func (m *SNMPObject) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			"mems":           newOtherFieldInfo(inputs.String, inputs.String, inputs.UnknownUnit, "Device memories (JSON format)."),
...
func (m *SNMPMetric) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			"fanSpeed":        newOtherFieldInfo(inputs.Float, inputs.Gauge, inputs.UnknownType, "The fan speed."),
