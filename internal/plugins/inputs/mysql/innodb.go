...
var innoDBMeasurementInfo = &inputs.MeasurementInfo{
	...
	Fields: map[string]interface{}{
		...
		"buffer_pool_bytes_dirty": &inputs.FieldInfo{
			...
			Type:     inputs.Gauge,
			Unit:     inputs.SizeByte,
			Desc:     "Buffer bytes currently dirty (innodb_buffer_pool_bytes_dirty)",
		},
		...
		"data_fsyncs": &inputs.FieldInfo{
			...
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The number of fsync() operations.",
		},
		...
		"data_read": &inputs.FieldInfo{
			...
			Type:     inputs.Count,
			Unit:     inputs.SizeByte,
			Desc:     "The amount of data read.",
		},
		"data_written": &inputs.FieldInfo{
			DataType: inputs.Int,
			Type:     inputs.Count,
			Unit:     inputs.SizeByte,
			Desc:     "The amount of data written.",
		},
		"dblwr_pages_written": &inputs.FieldInfo{
			DataType: inputs.Int,
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The number of pages written to the `doublewrite` buffer.",
		},
		"dblwr_writes": &inputs.FieldInfo{
			DataType: inputs.Int,
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The number of `doublewrite` operations performed.",
		},
		...
		"os_file_fsyncs": &inputs.FieldInfo{
			...
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The total number of fsync() operations performed by InnoDB.",
		},
		"os_file_reads": &inputs.FieldInfo{
			DataType: inputs.Int,
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The total number of file reads performed by read threads within InnoDB.",
		},
		"os_file_writes": &inputs.FieldInfo{
			DataType: inputs.Int,
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The total number of file writes performed by write threads within InnoDB.",
		},
