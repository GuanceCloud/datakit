...
// go test -v -timeout 30s -run ^TestCollect$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
...
// go test -v -timeout 30s -run ^TestMetricCollectMysqlGeneral$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
