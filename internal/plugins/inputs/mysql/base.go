...
var baseMeasurementInfo = &inputs.MeasurementInfo{
	...
	Fields: map[string]interface{}{
		...
		"Slow_queries": &inputs.FieldInfo{
			...
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The number of slow queries.",
		},
		"Questions": &inputs.FieldInfo{
			DataType: inputs.Int,
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The number of statements executed by the server.",
		},
		"Queries": &inputs.FieldInfo{
			DataType: inputs.Int,
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The number of queries.",
		},
		...
		"Connections": &inputs.FieldInfo{
			...
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The number of connection attempts to the server.",
		},
		...
		"Qcache_hits": &inputs.FieldInfo{
			...
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The number of query cache hits.",
		},
		...
		"Created_tmp_tables": &inputs.FieldInfo{
			...
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The number of internal temporary tables created by the server while executing statements.",
		},
		"Created_tmp_disk_tables": &inputs.FieldInfo{
			DataType: inputs.Int,
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The number of internal on-disk temporary tables created by the server while executing statements.",
		},
		"Created_tmp_files": &inputs.FieldInfo{
			DataType: inputs.Int,
			Type:     inputs.Count,
			Unit:     inputs.NCount,
			Desc:     "The number of temporary files created.",
		},
		// Thread Metrics
