...
// go test -v -timeout 30s -run ^TestGetCleanSchemaData$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
...
// go test -v -timeout 30s -run ^TestGetCleanInnodb$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
...
// go test -v -timeout 30s -run ^TestGetCleanTableSchema$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
...
// go test -v -timeout 30s -run ^TestGetCleanUserStatusName$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
...
// go test -v -timeout 30s -run ^TestGetCleanUserStatusVariable$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
...
// go test -v -timeout 30s -run ^TestGetCleanUserStatusConnection$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
...
// go test -v -timeout 30s -run ^TestGetCleanSummaryRows$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
			...
			expect: []dbmRow{
				{
					...
					/*"deltaRowsExamined": */ 0,
					/*"deltaSelectScan":   */ 0,
					/*"deltaSelectFullJoin":*/ 0,
					/*"deltaNoIndexUsed":  */ 0,
					/*"deltaNoGoodIndexUsed":*/ 0,
				},
			},
		},
	}
...
// go test -v -timeout 30s -run ^TestGetCleanEnabledPerformanceSchemaConsumers$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
...
// go test -v -timeout 30s -run ^TestGetCleanMysqlVersion$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
...
// go test -v -timeout 30s -run ^TestGetCleanMysqlCustomQueries$ gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/plugins/inputs/mysql
