...
func (*dbmPlanObjectMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Cat:  point.Object,
		//nolint:lll
		Desc:   "SQL Server DBM plan objects. Each object represents a unique execution plan identified by query_signature:query_plan_hash, containing the obfuscated plan content and encryption status.",
		DescZh: "SQL Server DBM 执行计划对象。每个对象代表一个由 query_signature:query_plan_hash 唯一标识的执行计划，包含脱敏后的计划内容和加密状态。",
		Tags: map[string]interface{}{
			"name":              inputs.NewTagInfo("Hash signature generated from query_signature:query_plan_hash"),
