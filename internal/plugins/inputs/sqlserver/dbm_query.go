...
func (*dbmQueryObjectMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Cat:  point.Object,
		//nolint:lll
		Desc:   "SQL Server DBM query objects. Each object represents a unique SQL query identified by server:database_instance:query_signature, containing the obfuscated SQL text and encryption status.",
		DescZh: "SQL Server DBM SQL 文本对象。每个对象代表一个由 server:database_instance:query_signature 唯一标识的 SQL 查询，包含脱敏后的 SQL 文本和加密状态。",
