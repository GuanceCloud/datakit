...
func (*docMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		Name: "neo4j",
		Cat:  point.Metric,
		Desc: "Neo4j Prometheus metrics collected from the configured metrics endpoint, " +
			"covering Bolt, database, page cache, transaction log, cluster, JVM, and legacy v3 metric families.",
		DescZh: "从配置的 Neo4j metrics endpoint 采集的 Prometheus 指标，包括 Bolt、数据库、page cache、事务日志、集群、JVM 以及 v3 旧版指标族。",
		Fields: getFields(),
...
var fieldNames []fieldName = []fieldName{
	...
	{name: "database_check_point_flushed_bytes", prefix: "database_", tag: []string{"db"}, suffix: "_check_point_flushed_bytes", fieldType: "gauge", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "The total number of bytes flushed during the most recent checkpoint event."}},
	...
	{name: "database_check_point_limit_times", prefix: "database_", tag: []string{"db"}, suffix: "_check_point_limit_times", fieldType: "gauge", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "The number of times the checkpoint process was limited during the most recent checkpoint."}},
	...
	{name: "dbms_page_cache_throttled_millis_total", prefix: "dbms_page_cache_throttled_millis_total", fieldType: "counter", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.DurationMS, Desc: "The total time in milliseconds that the page cache flush IO limiter throttled ongoing IO operations."}},
	...
	{name: "database_index_fulltext_queried_total", prefix: "database_", tag: []string{"db"}, suffix: "_index_fulltext_queried_total", fieldType: "counter", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "The total number of times fulltext indexes have been queried."}},
	...
	{name: "database_cluster_raft_tx_retries_total", prefix: "database_", tag: []string{"db"}, suffix: "_cluster_raft_tx_retries_total", fieldType: "counter", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "The total number of transaction retries performed by the Raft subsystem."}},
	...
	{name: "database_cluster_raft_in_flight_cache_total_bytes", prefix: "database_", tag: []string{"db"}, suffix: "_cluster_raft_in_flight_cache_total_bytes", fieldType: "gauge", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Current total size in bytes of the Raft in-flight cache."}},
	{name: "database_cluster_raft_in_flight_cache_max_bytes", prefix: "database_", tag: []string{"db"}, suffix: "_cluster_raft_in_flight_cache_max_bytes", fieldType: "gauge", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Maximum configured size in bytes of the Raft in-flight cache."}},
	...
	{name: "database_cluster_raft_in_flight_cache_hits_total", prefix: "database_", tag: []string{"db"}, suffix: "_cluster_raft_in_flight_cache_hits_total", fieldType: "counter", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "The total number of Raft in-flight cache lookups that were served from cache."}},
	{name: "database_cluster_raft_in_flight_cache_misses_total", prefix: "database_", tag: []string{"db"}, suffix: "_cluster_raft_in_flight_cache_misses_total", fieldType: "counter", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "The total number of Raft in-flight cache lookups that missed the cache."}},
	{name: "database_cluster_raft_raft_log_entry_prefetch_buffer_lag", prefix: "database_", tag: []string{"db"}, suffix: "_cluster_raft_raft_log_entry_prefetch_buffer_lag", fieldType: "gauge", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of Raft log entries by which the prefetch buffer lags behind the requested position."}},
	...
	{name: "database_cluster_raft_replication_maybe_total", prefix: "database_", tag: []string{"db"}, suffix: "_cluster_raft_replication_maybe_total", fieldType: "counter", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "The total number of Raft replication attempts whose outcome remained uncertain."}},
	...
	{name: "dbms_vm_memory_buffer_count", prefix: "dbms_vm_memory_buffer_", tag: []string{"bufferpool"}, suffix: "_count", fieldType: "gauge", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Estimated number of buffers in the pool."}},
	...
	{name: "bolt_sessions_started", prefix: "bolt_sessions_started", fieldType: "counter", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "(only for neo4j.v3) The total number of Bolt sessions started since this instance started."}},
	...
	{name: "network_master_network_store_writes", prefix: "network_master_network_store_writes", fieldType: "counter", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "(only for neo4j.v3) The master network store writes."}},
	{name: "network_master_network_tx_writes", prefix: "network_master_network_tx_writes", fieldType: "counter", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "(only for neo4j.v3) The master network transaction writes."}},
	{name: "network_slave_network_tx_writes", prefix: "network_slave_network_tx_writes", fieldType: "counter", field: &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Count, Unit: inputs.NCount, Desc: "(only for neo4j.v3) The slave network transaction writes."}},
}
