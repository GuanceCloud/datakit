...
func (*docMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		Name:   "couchdb",
		Cat:    point.Metric,
		Desc:   "CouchDB metrics scraped from Prometheus exporter output, covering authentication cache, replication, HTTP requests, and database operations.",
		DescZh: "从 Prometheus 导出器输出采集的 CouchDB 指标，涵盖认证缓存、复制、HTTP 请求和数据库操作。",
		Fields: map[string]interface{}{
			...
			"collect_results_time_seconds":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Microsecond latency for calls to couch_db:collect_results."},
			...
			"db_open_time_seconds":                                &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Milliseconds required to open a database."},
			"dbinfo_seconds":                                      &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Milliseconds required to DB info."},
			...
			"dreyfus_httpd_search_seconds":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Distribution of overall search request latency as experienced by the end user."},
			"dreyfus_index_await_seconds":                         &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Length of an dreyfus_index await request."},
			"dreyfus_index_group1_seconds":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Length of an dreyfus_index group1 request."},
			"dreyfus_index_group2_seconds":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Length of an dreyfus_index group2 request."},
			"dreyfus_index_info_seconds":                          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Length of an dreyfus_index info request."},
			"dreyfus_index_search_seconds":                        &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Length of an dreyfus_index search request."},
			"dreyfus_rpc_group1_seconds":                          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Length of a group1 RPC worker."},
			"dreyfus_rpc_group2_seconds":                          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Length of a group2 RPC worker."},
			"dreyfus_rpc_info_seconds":                            &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Length of an info RPC worker."},
			"dreyfus_rpc_search_seconds":                          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Length of a search RPC worker."},
			...
			"httpd_bulk_docs_seconds":                             &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Distribution of the number of docs in _bulk_docs requests."},
			...
			"mango_query_time_seconds":                            &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Length of time processing a mango query."},
			...
			"query_server_vdu_process_time_seconds":               &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Duration of validate_doc_update function calls."},
			...
			"request_time_seconds":                                &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Summary, Unit: inputs.DurationSecond, Desc: "Length of a request inside CouchDB without `MochiWeb`."},
