...
var nodestatsExpectedFunc = func() map[string]interface{} {
	...
	for k, v := range map[string]interface{}{
		...
		"fs_data_0_total_in_gigabytes":                      float64(19507089408) / (1024 * 1024 * 1024),
		"fs_data_0_free_in_gigabytes":                       float64(16909316096) / (1024 * 1024 * 1024),
		"fs_data_0_available_in_gigabytes":                  float64(15894814720) / (1024 * 1024 * 1024),
		"fs_timestamp":                                      float64(1436460392946),
		"fs_total_free_in_gigabytes":                        float64(16909316096) / (1024 * 1024 * 1024),
		"fs_total_available_in_gigabytes":                   float64(15894814720) / (1024 * 1024 * 1024),
		"fs_total_total_in_gigabytes":                       float64(19507089408) / (1024 * 1024 * 1024),
