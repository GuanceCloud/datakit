...
var indicesStatsFields = map[string]interface{}{
	...
	"primaries_indexing_index_total":          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Total number of indexing operations. Only for the primary shards."},
	"primaries_merges_total":                  &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Total number of merge operations. Only for the primary shards."},
	"primaries_merges_total_docs":             &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Total number of merged documents. Only for the primary shards."},
	"primaries_merges_current_docs":           &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of document merges currently running. Only for the primary shards."},
	"primaries_merges_total_time_in_millis":   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.DurationMS, Desc: "Total time in milliseconds spent performing merge operations. Only for the primary shards."},
	"primaries_flush_total":                   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of flush operations. Only for the primary shards."},
	"primaries_flush_total_time_in_millis":    &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.DurationMS, Desc: "Total time in milliseconds spent performing flush operations. Only for the primary shards."},
	"primaries_refresh_total":                 &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Total number of refresh operations. Only for the primary shards."},
	"primaries_refresh_total_time_in_millis":  &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.DurationMS, Desc: "Total time in milliseconds spent performing refresh operations. Only for the primary shards."},
	"primaries_search_fetch_current":          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of fetch operations currently running. Only for the primary shards."},
	"primaries_search_fetch_time_in_millis":   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.DurationMS, Desc: "Time in milliseconds spent performing fetch operations. Only for the primary shards."},
	"primaries_search_fetch_total":            &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Total number of fetch operations. Only for the primary shards."},
	"primaries_search_query_current":          &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of query operations currently running. Only for the primary shards."},
	"primaries_search_query_time_in_millis":   &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.DurationMS, Desc: "Time in milliseconds spent performing query operations. Only for the primary shards."},
	"primaries_search_query_total":            &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Total number of query operations. Only for the primary shards."},
	"primaries_store_size_in_bytes":           &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.SizeByte, Desc: "Total size, in bytes, of all shards assigned to selected nodes. Only for the primary shards."},
	"primaries_docs_count":                    &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of documents. Only for the primary shards."},
	"primaries_docs_deleted":                  &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of deleted documents. Only for the primary shards."},
	"index_number_of_shards":                  &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of shards."},
	"index_number_of_replicas":                &inputs.FieldInfo{DataType: inputs.Float, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of replicas."},
}
