...
func (ipt *Input) Dashboard(lang inputs.I18n) map[string]string {
	...
	case inputs.I18nZh:
		return map[string]string{
			...
			"intro_content":               `Datakit 自身指标展示（Datakit >= 1.11.0），默认由 dk 采集器采集。详情参见[这里](https://docs.guance.com/datakit/datakit-metrics/)暴露的指标。`,
	...
	case inputs.I18nEn:
		return map[string]string{
			...
			"intro_content":               `This dashboard shows DataKit self-metrics (requires DataKit >= 1.11.0), collected by the dk input by default. For more metrics, see [here](https://docs.guance.com/en/datakit/datakit-metrics/).`,
