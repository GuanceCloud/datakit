...
func (meas) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			"datakit_goroutine_alive":                          &inputs.FieldInfo{Type: inputs.Gauge, DataType: inputs.Float, Desc: "Alive Goroutine"},
			"datakit_goroutine_stopped_total":                  &inputs.FieldInfo{Type: inputs.Count, DataType: inputs.Float, Desc: "Stopped Goroutine"},
