...
import (
	...
	"gitlab.jiagouyun.com/cloudcare-tools/datakit/internal/kubernetes/pkg/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type LoggingV1alpha1Interface interface {
	RESTClient() rest.Interface
	ClusterLoggingConfigsGetter
}

// LoggingV1alpha1Client is used to interact with features provided by the logging.datakits.io group.
type LoggingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *LoggingV1alpha1Client) ClusterLoggingConfigs() ClusterLoggingConfigInterface {
	return newClusterLoggingConfigs(c)
}
