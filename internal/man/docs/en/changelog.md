...
- Pipeline
  - Add protective measures to the [`kv_split()`](../developers/pipeline/pipeline-built-in-function/#fn-kv_split) function to prevent data inflation (#1510)
  - Optimize the functionality of [`json()`](../developers/pipeline/pipeline-built-in-function/#fn-json) and [`delete()`](../developers/pipeline/pipeline-built-in-function/#fn-delete) for processing JSON keys.
...
- Pipeline
    - Add [key deletion](../developers/pipeline/pipeline-built-in-function/#fn-json) for `json` function (#1465)
    - Add new function [`kv_split()`](../developers/pipeline/pipeline-built-in-function/#fn-kv_split)(#1414)
    - Add new function[`datatime()`](../developers/pipeline/pipeline-built-in-function/#fn-datetime)(#1411)
...
- Optimize Pipeline funciton [`replace()`](../developers/pipeline/pipeline-built-in-function/#fn-replace) performance (#1477)
