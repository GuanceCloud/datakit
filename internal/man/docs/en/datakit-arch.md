...
- Top level: including program entry module and some public modules
	...
	- Pipeline module: In log processing, through  [Pipeline script](../developers/pipeline/), the log is cut, and the unstructured log data is converted into structured data. In other non-log data, corresponding data processing can also be performed.
