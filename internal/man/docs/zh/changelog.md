...
- Pipeline 新增聚合类函数(#1554)
    - [agg_create()](../developers/pipeline/pipeline-built-in-function/#fn-agg-create)
    - [agg_metric()](../developers/pipeline/pipeline-built-in-function/#fn-agg-metric)
...
- Pipeline
    - [`kv_split()`](../developers/pipeline/pipeline-built-in-function/#fn-kv_split) 函数增加强制保护措施，避免数据膨胀(#1510)
    - 关于 JSON 的处理，优化了 [`json()`](../developers/pipeline/pipeline-built-in-function/#fn-json) 和 [`delete()`](../developers/pipeline/pipeline-built-in-function/#fn-delete) 删除 key 的功能。
- 其它工程上的优化(#1500)
...
- Pipeline
    - `json` 函数增加 [key 删除](../developers/pipeline/pipeline-built-in-function/#fn-json) 功能(#1465)
    - 增加函数 [`kv_split()`](../developers/pipeline/pipeline-built-in-function/#fn-kv_split)(#1414)
    - 增加[时间函数](../developers/pipeline/pipeline-built-in-function/#fn-datetime)(#1411)
...
- 优化 Pipeline [`replace()`](../developers/pipeline/pipeline-built-in-function/#fn-replace.md) 性能(#1477)
...
- 新增 Pipeline 函数(#1220/#1224)
    - [sample()](../developers/pipeline/pipeline-built-in-function/#fn-sample)：采样函数
    - [b64enc()](../developers/pipeline/pipeline-built-in-function/#fn-b64enc)：Base64 编码函数
    - [b64dec()](../developers/pipeline/pipeline-built-in-function/#fn-b64dec)：Base64 解码函数
    - [append()](../developers/pipeline/pipeline-built-in-function/#fn-append)：列表追加函数
    - [url_parse()](../developers/pipeline/pipeline-built-in-function/#fn-url-parse)：HTTP URL 解析函数
...
- Pipeline 优化(#1188)
    - 优化 [grok()](../developers/pipeline/pipeline-built-in-function/#fn-grok) 等函数，使得其可以用在 `if/else` 语句中，以判定操作是否生效
    - 增加 [match()](../developers/pipeline/pipeline-built-in-function/#fn-match) 函数
    - 增加 [cidr()](../developers/pipeline/pipeline-built-in-function/#fn-cidr) 函数(#733)
...
- Pipeline 相关更新：
    ...
    - [`grok()`](../developers/pipeline/pipeline-built-in-function/#fn-grok) 和 [`json()`](../developers/pipeline/pipeline-built-in-function/#fn-json) 函数默认执行 trim-space 操作(#1001)
...
- [Pipeline](../developers/pipeline/) 增加 [Profiling 类数据](profile.md)支持(#866)
