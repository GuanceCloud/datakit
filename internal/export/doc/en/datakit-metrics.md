...
| COUNTER | `datakit_io_grouped_request_total`                            | `category`                                                                                | Grouped requests under sinker                                                                                        |
...
| SUMMARY | `datakit_kubernetes_collect_resource_pts_num`                 | `category,kind,fieldselector`                                                             | Kubernetes resource collect point count                                                                              |
