...
![](https://static.guance.com/images/datakit/datakit-eks-architecture-overview.png)
...
- You need to get it in advance `DK_DATAWAY`. You can also obtain it by following the instructions below:
  ...
  2. Click the 「Integration」 menu, then select the 「DataKit」 TAB and copy the `DK_DATAWAY` parameter
     ![](https://static.guance.com/images/datakit/datakit-eks-en-get-datawayurl.png)
...
![](https://static.guance.com/images/datakit/datakit-eks-en-verify.png)
