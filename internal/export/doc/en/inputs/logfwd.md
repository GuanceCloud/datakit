...
| `LOGFWD_GLOBAL_FROM_BEGINNING_THRESHOLD_SIZE` | Global `from_beginning_threshold_size`, in bytes, priority higher than the `from_beginning_threshold_size` field in individual configurations.                                                                                       |
