...
> 注意：如果原来 tag 中就存在一个名为 `measurement/class/source` 的 tag，那么**在过滤器运行过程中，原来的 measurement/class/source 这些 tag 值将不存在**
...
过滤器基本语法规则，跟 Pipeline 基本一致，参见[这里](../pipeline/use-pipeline/pipeline-platypus-grammar.md)。
