...
> 注意：Mac 下，如果通过 [`datakit install --telegraf` 安装](../datakit/datakit-tools-how-to.md#extras)，配置目录和 Linux 一样。
...
如果 [DataKit API 位置有调整](datakit-conf.md#config-http-server)，需调整如下配置，将 `url` 设置到 DataKit API 真实的地址即可：
