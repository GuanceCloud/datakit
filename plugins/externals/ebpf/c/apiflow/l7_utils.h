...
static __always_inline int record_http_req(void *ctx,
  ...
  bpf_perf_event_output(ctx, &bpfmap_l7_buffer_out, bpf_get_smp_processor_id(),
...
static __always_inline int record_http_resp(void *ctx,
                                            ...
                                            struct layer7_http *stats,
                                            enum MSG_RW rw) {
  struct layer7_http *stats_cached =
  ...
  __builtin_memcpy(&http_finished.http, stats_cached,
  ...
  bpf_perf_event_output(ctx, &bpfmap_httpreq_fin_event,
                        bpf_get_smp_processor_id(), &http_finished,
