...
// go test -v -timeout 30s -run ^Test_initializeDiscovery$ gitlab.jiagouyun.com/cloudcare-tools/datakit/plugins/inputs/snmp
...
// go test -v -timeout 30s -run ^Test_addDynamicDevice$ gitlab.jiagouyun.com/cloudcare-tools/datakit/plugins/inputs/snmp
...
// go test -v -timeout 30s -run ^Test_removeDynamicDevice$ gitlab.jiagouyun.com/cloudcare-tools/datakit/plugins/inputs/snmp
...
// go test -v -timeout 30s -run ^Test_isIPIgnored$ gitlab.jiagouyun.com/cloudcare-tools/datakit/plugins/inputs/snmp
...
// go test -v -timeout 30s -run ^Test_incrementIP$ gitlab.jiagouyun.com/cloudcare-tools/datakit/plugins/inputs/snmp
