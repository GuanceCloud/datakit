...
func (r MockedResolver) GetVariableMetadata(_ string, varOid string) (VariableMetadata, error) {
...
func TestSortFiles(t *testing.T) {
	files := []fs.DirEntry{
		...
		MockedDirEntry{name: "default_traps_db.json.gz", isDir: true},
		MockedDirEntry{name: "default_traps_db.json", isDir: true},
		MockedDirEntry{name: "default_traps_db.yaml.gz", isDir: true},
		MockedDirEntry{name: "default_traps_db.yaml", isDir: true},
		MockedDirEntry{name: "default_traps_db.json.gz", isDir: false},
		MockedDirEntry{name: "default_traps_db.json", isDir: false},
		MockedDirEntry{name: "default_traps_db.yaml.gz", isDir: false},
		MockedDirEntry{name: "default_traps_db.yaml", isDir: false},
	}
	sortedFiles := getSortedFileNames(files)
	require.EqualValues(t,
		[]string{
			"default_traps_db.json",
			"default_traps_db.json.gz",
			"default_traps_db.yaml",
			"default_traps_db.yaml.gz",
			"chihiro",
			"kiki",
			"mononoke",
			"Nausicaa",
