...
// go test -v -timeout 30s -run ^Test_getProfileForSysObjectID$ gitlab.jiagouyun.com/cloudcare-tools/datakit/plugins/inputs/snmp/snmputil
...
// go test -v -timeout 30s -run ^Test_refreshWithProfile$ gitlab.jiagouyun.com/cloudcare-tools/datakit/plugins/inputs/snmp/snmputil
...
// go test -v -timeout 30s -run ^Test_oidConfig_addScalarOids$ gitlab.jiagouyun.com/cloudcare-tools/datakit/plugins/inputs/snmp/snmputil
...
// go test -v -timeout 30s -run ^Test_oidConfig_addColumnOids$ gitlab.jiagouyun.com/cloudcare-tools/datakit/plugins/inputs/snmp/snmputil
...
// go test -v -timeout 30s -run ^Test_ValidateEnrichMetrics$ gitlab.jiagouyun.com/cloudcare-tools/datakit/plugins/inputs/snmp/snmputil
...
// go test -v -timeout 30s -run ^Test_validateEnrichMetadata$ gitlab.jiagouyun.com/cloudcare-tools/datakit/plugins/inputs/snmp/snmputil
