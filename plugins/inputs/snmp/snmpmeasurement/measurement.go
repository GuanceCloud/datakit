...
func (m *SNMPObject) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Type: "object",
		Fields: map[string]interface{}{
			"device_meta":                       newOtherFieldInfo(inputs.String, inputs.String, inputs.UnknownUnit, "设备的元数据 (JSON 格式字符串)"),
			...
			"cieIfLastOutTime":                  newOtherFieldInfo(inputs.Int, inputs.Gauge, inputs.TimestampMS, "[Cisco only] (Shown as millisecond) The elapsed time in milliseconds since the last protocol output packet was transmitted."),
			...
			"cieIfLastInTime":                   newOtherFieldInfo(inputs.Int, inputs.Gauge, inputs.TimestampMS, "[Cisco only] (Shown as millisecond) The elapsed time in milliseconds since the last protocol input packet was received."),
		...
		Tags: map[string]interface{}{
			"device_vendor":      inputs.NewTagInfo("设备生产商"),
			"host":               inputs.NewTagInfo("设备名"),
			"interface":          inputs.NewTagInfo("设备接口名"),
			"interface_alias":    inputs.NewTagInfo("设备接口别名"),
			"snmp_profile":       inputs.NewTagInfo("SNMP 配置文件名"),
			"mac_addr":           inputs.NewTagInfo("设备的 MAC 地址"),
			"entity_name":        inputs.NewTagInfo("实体名"),
