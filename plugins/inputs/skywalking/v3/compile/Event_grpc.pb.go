...
func (x *eventServiceCollectClient) CloseAndRecv() (*Commands, error) {
...
func (x *eventServiceCollectServer) SendAndClose(m *Commands) error {
...
var _EventService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "plugins/inputs/skywalking/v3/proto/event/Event.proto",
}
