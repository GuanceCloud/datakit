...
func (m *mongodbMeasurement) LineProto() (*dkpt.Point, error) {
...
func (m *mongodbMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			"flushes_total_time_ns":          &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: `The transaction checkpoint total time (ms)"`},                                                                                                                                                                                                                                                                                 // (integer)
			...
			"resident_megabytes": &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: `The value of mem.resident is roughly equivalent to the amount of RAM, in MiB, currently used by the database process.`}, // (integer)
			...
			"tcmalloc_pageheap_decommit_count":          &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: `Number of virtual memory de-commits.`},                                                                                                                                                // (integer)
			...
			"tcmalloc_pageheap_scavenge_count":          &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: `Number of times scavaged flush pages.`},                                                                                                                                               // (integer)
			...
			"tcmalloc_pageheap_total_decommit_bytes":    &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: `Bytes de-committed in lifetime of process.`},                                                                                                                                          // (integer)
			...
			"tcmalloc_pageheap_unmapped_bytes":          &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: `Total bytes on returned free lists.`},                                                                                                                                                 // (integer)
			...
			"tcmalloc_total_free_bytes":                 &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: `Total bytes on normal free lists.`},                                                                                                                                                   // (integer)
			...
			"vsize_megabytes":                      &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: `mem.virtual displays the quantity, in MiB, of virtual memory used by the mongod process.`},                // (integer)
			...
			"wtcache_pages_written_from":           &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Pages written from cache"},                                                                                // (integer)
			"page_faults_per_sec":                  &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Page Faults/sec is the average number of pages faulted per second. (Existed in 3.0 and earlier version)"}, // (integer)
			"mapped_megabytes":                     &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Mapped megabytes. (Existed in 3.0 and earlier version)"},                                                  // (integer)
			"non-mapped_megabytes":                 &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Non mapped megabytes. (Existed in 3.0 and earlier version)"},                                              // (integer)
		},
	}
}
...
func (m *mongodbDBMeasurement) LineProto() (*dkpt.Point, error) {
	// return point.NewPoint(m.name, m.tags, m.fields, point.MOptElectionV2(m.election))
	return nil, fmt.Errorf("not implement")
}
...
func (m *mongodbDBMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			"wtcache_internal_pages_evicted":       &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"wtcache_pages_written_from":           &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Pages written from cache. (Existed in 3.0 and earlier version)"},                                                                                              // (integer)
			"wtcache_server_evicting_pages":        &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"wtcache_pages_requested_from":         &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of pages request from the cache. (Existed in 3.0 and earlier version)"},                                                                                // (integer)
			"wtcache_app_threads_page_write_count": &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"wtcache_worker_thread_evictingpages":  &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"wtcache_bytes_written_from":           &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"wtcache_max_bytes_configured":         &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Maximum cache size. (Existed in 3.0 and earlier version)"},                                                                                                    // (integer)
			"wtcache_pages_evicted_by_app_thread":  &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"wtcache_pages_queued_for_eviction":    &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"wtcache_bytes_read_into":              &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"percent_cache_used":                   &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Size in byte of the data currently in cache. This value should not be greater than the maximum bytes configured value. (Existed in 3.0 and earlier version)"}, // (integer)
			"wtcache_pages_read_into":              &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Number of pages read into the cache. (Existed in 3.0 and earlier version)"},                                                                                   // (integer)
			"wtcache_current_bytes":                &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"page_faults_per_sec":                  &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Page Faults/sec is the average number of pages faulted per second. (Existed in 3.0 and earlier version)"},                                                     // (integer)
			"wtcache_app_threads_page_read_time":   &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"wtcache_tracked_dirty_bytes":          &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"wtcache_modified_pages_evicted":       &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"non-mapped_megabytes":                 &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Non mapped megabytes. (Existed in 3.0 and earlier version)"},                                                                                                  // (integer)
			"wtcache_unmodified_pages_evicted":     &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Main statistics for page eviction. (Existed in 3.0 and earlier version)"},                                                                                     // (integer)
			"percent_cache_dirty":                  &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Size in bytes of the dirty data in the cache. This value should be less than the bytes currently in the cache value. (Existed in 3.0 and earlier version)"},   // (integer)
			"wtcache_app_threads_page_read_count":  &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                                                                        // (integer)
			"mapped_megabytes":                     &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "Mapped megabytes. (Existed in 3.0 and earlier version)"},                                                                                                      // (integer)
		},
	}
}
...
func (m *mongodbColMeasurement) LineProto() (*dkpt.Point, error) {
	// return point.NewPoint(m.name, m.tags, m.fields, point.MOptElectionV2(m.election))
	return nil, fmt.Errorf("not implement")
}
...
func (m *mongodbShardMeasurement) LineProto() (*dkpt.Point, error) {
	// return point.NewPoint(m.name, m.tags, m.fields, point.MOptElectionV2(m.election))
	return nil, fmt.Errorf("not implement")
}
...
func (m *mongodbTopMeasurement) LineProto() (*dkpt.Point, error) {
	// return point.NewPoint(m.name, m.tags, m.fields, point.MOptElectionV2(m.election))
	return nil, fmt.Errorf("not implement")
}
