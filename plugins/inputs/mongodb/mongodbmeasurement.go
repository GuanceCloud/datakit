...
func (m *mongodbDBMeasurement) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			...
			"wtcache_pages_requested_from":         &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                    // (integer)
			...
			"wtcache_max_bytes_configured":         &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                    // (integer)
			...
			"percent_cache_used":                   &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                    // (integer)
			"wtcache_pages_read_into":              &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                    // (integer)
			...
			"non-mapped_megabytes":                 &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                    // (integer)
			"wtcache_unmodified_pages_evicted":     &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                    // (integer)
			"percent_cache_dirty":                  &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                    // (integer)
			...
			"mapped_megabytes":                     &inputs.FieldInfo{DataType: inputs.Int, Type: inputs.Gauge, Unit: inputs.NCount, Desc: "(Existed in 3.0 and earlier version)"},                                                                    // (integer)
		},
	}
}
