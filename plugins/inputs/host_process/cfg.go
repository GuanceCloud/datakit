...
func (m *ProcessMetric) Info() *inputs.MeasurementInfo {
	return &inputs.MeasurementInfo{
		...
		Fields: map[string]interface{}{
			"threads":          newOtherFieldInfo(inputs.Int, inputs.Count, inputs.UnknownUnit, "线程数"),
			...
			"open_files":       newOtherFieldInfo(inputs.Int, inputs.Count, inputs.UnknownUnit, "open_files 个数(仅支持linux)"),
		},
