...
type swSegmentFilter func(segment *SkyWalkSegment) *SkyWalkSegment

func swSegSample(segment *SkyWalkSegment) *SkyWalkSegment {
	var rootSpan *SkyWalkSpan
...
func convertSkywalkTags(swtags []*SkyWalkTag) map[string]string {
	var tags map[string]string
