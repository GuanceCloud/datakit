...
func (i *Input) Collect() error {
	...
	for _, ioStat := range filteredInterface {
...
func init() {
	inputs.Add(inputName, func() inputs.Input {
		return &Input{netIO: NetIOCounters, netProto: NetProtoCounters, netVirtualIfaces: NetVirtualInterfaces}
	})
}
